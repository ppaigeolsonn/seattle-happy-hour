    ...
    <main className="mx-auto w-full max-w-6xl px-4 py-10">
      ...
      <div className="mt-6 flex flex-wrap items-center gap-4">
        ...
        <label className="flex cursor-pointer select-none items-center gap-2">
          ...
          />
          <span className="relative h-6 w-11 shrink-0 rounded-full bg-neutral-200 transition-colors peer-checked:bg-orange-500">
            <span className="absolute left-1 top-1 h-4 w-4 rounded-full bg-white transition-transform peer-checked:translate-x-5" />
          </span>
          <span className="text-sm text-neutral-700">Happy hour now</span>
        </label>
      </div>
